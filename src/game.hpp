...
if (config::get("visual", "visual_crosshair", 0)) {
    ...
    void game_render_menu() {
        ...
        try { voiden_menu::render(Game.menuOpen); } catch (...) { NOCTUA_RUNTIME_LOG("menu_render cxx exception"); }
    }
...
namespace noctua_license { namespace mark_71a9eb5269b9903b04645e52bb202bd7 {
